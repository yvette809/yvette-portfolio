...
export default function About() {
  return (
    <section id="about" className="py-20 md:py-28 px-[5vw] relative z-[2]">
          ...
          <div className="bg-surface border border-white/[0.07] rounded-xl p-6 sm:p-10 relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              {STACK.map((item) => (
                <div
                  key={item}
                  className="stack-item font-mono text-[0.72rem] sm:text-[0.78rem] text-muted py-2 sm:py-2.5 px-2.5 sm:px-3 border border-white/[0.07] rounded bg-bg2 flex items-center gap-2 hover:border-mint hover:text-mint hover:bg-[var(--mint-dim)] transition-all"
                >
